...
<html lang="en">
    ...
    <!--The logo on the left <a class="navbar-brand" href="index.php"><img alt="Brand" src="assets/img/logo.png" height="40px"></a> -->
                </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <form action="<?php $_PHP_SELF ?>" method="POST" accept-charset="utf-8" class="form" role="form">
                                        ...
                                        <br />
                                        <span class="help-block">By clicking on "Create my account", you agree to our Terms and that you have read our Data Use Policy, including our Cookie Use.</span>
        ...
        <div class="copyright-bar bg-black">
            <div class="container">
                <p class="pull-right small"><a href="adminlogin.php">Administrator</a></p>
            </div>
        </div>
        <!-- footer end -->
    </div>
